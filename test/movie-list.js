export const movieList = [
    ...
    },
    {
        ...
        movieTag: "eaux_troubles",
        synopsis: "Au cœur de l’océan Pacifique, le sous-marin d’une équipe de chercheurs a été attaqué par une créature gigantesque qu’on croyait disparue : le Megalodon, un requin préhistorique de 23 mètres de long.\nLe sauveteur-plongeur Jonas Taylor doit risquer sa vie pour sauver les hommes et les femmes prisonniers de l'embarcation… et affronter le prédateur le plus terrible de tous les temps. "
    },
    {
        id: 8,
        title: "Alpha",
